...
const getAllProducts = async (req, res) => {
  ...
  const page = Number(req.query.page) || 1; // if user does not ?page=mumber then we just use default which is 1 also we use Number() function to convert string to int
